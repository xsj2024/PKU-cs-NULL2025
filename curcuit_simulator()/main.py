import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QGraphicsView, QToolBar, QAction, QVBoxLayout, QWidget, QMessageBox
from PyQt5.QtCore import Qt, QPointF
from PyQt5.QtGui import QPen, QColor, QPainter, QBrush, QTransform
from spice_generator import generate_spice_netlist
# 导入之前定义的类（假设这些类在 components.py 中）
